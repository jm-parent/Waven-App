...
class _ArmoryBuilderPageState extends State<ArmoryBuilderPage> {
  ...
  _onGodClicked(className) {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => ArmoryBuilderCreatePage(
                urlClasseBackground:
                    "images/background_logo/logo_$className.png",
              )),
    );
  }
}
...
class GridGodItem extends StatelessWidget {
  ...
  GridGodItem({Key key, @required this.loreTitle, this.imgUrl})
          ...
          child: new Container(
            ...
            child: Container(
              decoration: new BoxDecoration(
                border: new Border.all(color: DarkColor()),
