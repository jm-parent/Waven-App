...
final GalleryItems = <GalleryOfflineModel>[

  new GalleryOfflineModel('Harazel','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/535598739512098817/IOPSPECTRAL.jpg','Ténébreux Spectral'),
  new GalleryOfflineModel('Kindry','UrlTwitter','https://media.discordapp.net/attachments/372126992859922433/530793778152210444/20190104_180439.jpg?width=242&height=326','Ténébreux Spectral'),
  new GalleryOfflineModel('Mystic-Wave','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/529755694417707060/JPEG_20190101_202008.jpg','Ténébreux Spectral'),
  new GalleryOfflineModel('Aon','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/526453340528443452/IMG_20181223_181934.jpg','Ténébreux Spectral'),
  new GalleryOfflineModel('Harazel','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/534801815963828225/IOP_DE_FEU.jpg','Ténébreux Spectral'),
  new GalleryOfflineModel('Dida','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/530866671729246218/Logo_FanMade.png','Ténébreux Spectral'),
  new GalleryOfflineModel('Aon','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/510443260775235585/IMG_20181109_141716.jpg','Ténébreux Spectral'),
  new GalleryOfflineModel('Joris','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/530818174195859467/unknown.png','Ténébreux Spectral'),
  new GalleryOfflineModel('Joris','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/530817970247827457/unknown.png','Ténébreux Spectral'),
  new GalleryOfflineModel('Harazel','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/526149167425257474/IOPETTE.png','Ténébreux Spectral'),
  new GalleryOfflineModel('Harazel','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/523615253137981458/iop_au_coeur_froid.png','Ténébreux Spectral'),
  new GalleryOfflineModel('Aon','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/510103345051074560/IMG_20181108_154757.jpg','Ténébreux Spectral'),
  new GalleryOfflineModel('Kouett','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/522197263146156033/unknown.png','Ténébreux Spectral'),
  new GalleryOfflineModel('Mikkoku','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/521068093016113166/Ecarlequin.png','Ténébreux Spectral'),
  new GalleryOfflineModel('RunningDove7373','UrlTwitter','https://pbs.twimg.com/media/Dtid18tUwAApxqc.png:large','Ténébreux Spectral'),
  new GalleryOfflineModel('Aon','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/510920060122955776/sacrieur.png','Ténébreux Spectral'),

  new GalleryOfflineModel('Aon','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/511551250588893194/IMG_20181112_153954.jpg','Ténébreux Spectral'),
  ...
  new GalleryOfflineModel('Dida','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/477977929632972803/Zone02MV.jpg','Ténébreux Spectral'),
  new GalleryOfflineModel('Dida','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/477977695511248906/croquis_prepara.jpg','Ténébreux Spectral'),
  new GalleryOfflineModel('Dida','UrlTwitter','https://cdn.discordapp.com/attachments/471247713808285706/475319652860559380/Magica_voxel.jpg','Ténébreux Spectral'),

];

class GalleryOfflineModel {
  ...
  GalleryOfflineModel(this.artistName, this.twitterUrl, this.imageUrl, this.artName);
