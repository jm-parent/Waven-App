...
class WeaponDetailEnterAnim {
  WeaponDetailEnterAnim(this.controller)
    ...
    new CurvedAnimation(
      ...
      curve: new Interval(
        ...
        dividerWidth = new Tween(begin: 0.0, end: 1000.0).animate(
          new CurvedAnimation(
            parent: controller,
            curve: new Interval(
              0.650,
        ...
        portraitOpacity = new Tween(begin: 0.0, end: 1.0).animate(
          new CurvedAnimation(
            parent: controller,
            curve: new Interval(
              0.300,
        ...
        nameWeaponOpacity = new Tween(begin: 0.0, end: 1.0).animate(
          new CurvedAnimation(
            parent: controller,
            curve: new Interval(
              0.4,
        ...
        descWeaponOpacity = new Tween(begin: 0.0, end: 1.0).animate(
          new CurvedAnimation(
            parent: controller,
            curve: new Interval(
              0.5,
  ...
  final Animation<double> nameWeaponOpacity;
  final Animation<double> descWeaponOpacity;
}