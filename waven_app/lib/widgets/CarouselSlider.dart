...
class CarouselSlider extends StatefulWidget {
  CarouselSlider({
    ...
    this.updateCallback, this.withDisto : true,
      ...
      itemBuilder: (BuildContext context, int i) {
        ...
        return AnimatedBuilder(
            ...
            builder: (BuildContext context, child) {
              ...
              final double distortionValue = widget.withDisto ?
              widget.enlargeCenterPage ? Curves.easeOut.transform(value) : 1.0 : 1.0;
