...
class ResideCustomMenu extends StatefulWidget {
  // your content View
  final Widget child;
  ...
  @override
  _ResideCustomMenuState createState() => new _ResideCustomMenuState();
}

class _ResideCustomMenuState extends State<ResideCustomMenu> with TickerProviderStateMixin {
  // the last move point
  ...
  @override
  void didUpdateWidget(ResideCustomMenu oldWidget) {
